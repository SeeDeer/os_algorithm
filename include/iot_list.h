 ...
 * @brief: xxx
 * @version: 1.0.0
 * @LastEditTime: 2021-08-25 22:25:42
...
typedef struct iot_list_head {
	struct iot_list_head *next, *prev;
}IOT_LIST_HEAD_T;
 ...
 * @return {*}
 *************************************************/
#define LIST_NODE_ADD(node,__prev,__next) do { \
 ...
 * @return {*}
 *************************************************/
#define LIST_NODE_DEL(__prev,__next) do { \
